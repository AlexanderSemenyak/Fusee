...
namespace Fusee.Xene
{
    ...
    public static class ViseratorExtensions
    {
        ...
        public static IEnumerable<TResult> Viserate<TViserator, TResult, TNode, TComponent>(this TNode root) 
            ...
            where TComponent : class, IComponent
        {
            return new ViseratorEnumerable<TViserator, TResult, TNode, TComponent> { _rootList = SceneVisitorHelpers.SingleRootEnumerator(root) };
        }
    ...
    public abstract class ViseratorBase<TItem, TNode, TComponent> : SceneVisitor<TNode, TComponent>, IEnumerator<TItem>
        where TNode : class, INode
        where TComponent : class, IComponent
    {
